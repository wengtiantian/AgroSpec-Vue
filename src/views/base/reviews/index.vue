<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="服务主体" prop="servicerId">
        <el-input
          v-model="queryParams.servicerId"
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['base:reviews:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          icon="Download"
          @click="handleExport"
          v-hasPermi="['base:reviews:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="reviewsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="五星评分" align="center" prop="rating" />
      <el-table-column label="是否删除" align="center" prop="isDelete" />
      <el-table-column label="服务质量维度" align="center" prop="SQdim" />
      <el-table-column label="情感评分" align="center" prop="SenScore" />
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['base:reviews:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['base:reviews:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
...
import { listReviews, getReviews, delReviews, addReviews, updateReviews } from "@/api/base/reviews";
...
function handleExport() {
  proxy.download('base/reviews/export', {
    ...queryParams.value
