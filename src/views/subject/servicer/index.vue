    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="servicerRef" :model="form" :rules="rules">
        ...
        <el-form-item label="主体介绍" prop="introduce">
          <el-input v-model="form.introduce" type="textarea" placeholder="请输入主体介绍" />
        </el-form-item>
        ...
        <el-form-item label="主体图片" prop="pictureUrls">
          <image-upload v-model="form.pictureUrls" :limit="5" />
        </el-form-item>
        <el-form-item label="从业人数" prop="population">
          <el-input-number v-model="form.population" :min="0" placeholder="请输入从业人数" />
        </el-form-item>
        <el-form-item label="年服务营业收入" prop="income">
          <el-input-number v-model="form.income" :min="0" :precision="2" placeholder="请输入年服务营业收入" />
        </el-form-item>
        <el-form-item label="服务对象数" prop="serveNum">
          <el-input-number v-model="form.serveNum" :min="0" placeholder="请输入服务对象数" />
        </el-form-item>
        <el-form-item label="服务小农户数" prop="farmersNum">
          <el-input-number v-model="form.farmersNum" :min="0" placeholder="请输入服务小农户数" />
        </el-form-item>
        <el-form-item label="年服务面积" prop="serveArea">
          <el-input-number v-model="form.serveArea" :min="0" :precision="2" placeholder="请输入年服务面积" />
        </el-form-item>
        <el-form-item label="年畜牧服务量" prop="raiseNum">
          <el-input-number v-model="form.raiseNum" :min="0" placeholder="请输入年畜牧服务量" />
        </el-form-item>
        <el-form-item label="年水产服务量" prop="waterNum">
          <el-input-number v-model="form.waterNum" :min="0" placeholder="请输入年水产服务量" />
        </el-form-item>
        <el-form-item label="其他行业服务总量" prop="otherNum">
          <el-input-number v-model="form.otherNum" :min="0" placeholder="请输入其他行业服务总量" />
        </el-form-item>
        <el-form-item label="服务粮食作物面积" prop="cropArea">
          <el-input-number v-model="form.cropArea" :min="0" :precision="2" placeholder="请输入服务粮食作物面积" />
        </el-form-item>
        <el-form-item label="是否认证" prop="isAuth">
...
import { listServicer, getServicer, delServicer, addServicer, updateServicer } from "@/api/subject/servicer.js";
