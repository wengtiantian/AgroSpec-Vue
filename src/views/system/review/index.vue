        ...
        <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
            ...
            <el-form-item label="是否删除" prop="isDelete">
                <el-select v-model="queryParams.isDelete" placeholder="请选择是否删除" clearable>
                    <el-option v-for="dict in es_is_delete" :key="dict.value" :label="dict.label" :value="dict.value" />
                </el-select>
            </el-form-item>
        ...
        <el-row :gutter="10" class="mb8">
            <el-col :span="1.5">
                <el-button type="primary" plain icon="Plus" @click="handleAdd"
                    v-hasPermi="['system:reviews:add']">新增</el-button>
            </el-col>
            <el-col :span="1.5">
                <el-button type="success" plain icon="Edit" :disabled="single" @click="handleUpdate"
                    v-hasPermi="['system:reviews:edit']">修改</el-button>
            </el-col>
            <el-col :span="1.5">
                <el-button type="danger" plain icon="Delete" :disabled="multiple" @click="handleDelete"
                    v-hasPermi="['system:reviews:remove']">删除</el-button>
            </el-col>
            <el-col :span="1.5">
                <el-button type="warning" plain icon="Download" @click="handleExport"
                    v-hasPermi="['system:reviews:export']">导出</el-button>
            </el-col>
        ...
        <el-table v-loading="loading" :data="reviewsList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="是否删除" align="center" prop="isDelete">
                <template #default="scope">
                    <dict-tag :options="es_is_delete" :value="scope.row.isDelete" />
                </template>
            </el-table-column>
            ...
            <el-form ref="reviewsRef" :model="form" :rules="rules" label-width="80px">
                ...
                <el-form-item label="是否删除" prop="isDelete">
                    <el-radio-group v-model="form.isDelete">
                        <el-radio v-for="dict in es_is_delete" :key="dict.value" :label="parseInt(dict.value)">{{ dict.label
                        }}</el-radio>
                    </el-radio-group>
                </el-form-item>
            </el-form>
...
const { es_is_delete } = proxy.useDict('es_is_delete');
...
function handleExport() {
    proxy.download('system/reviews/export', {
        ...queryParams.value
